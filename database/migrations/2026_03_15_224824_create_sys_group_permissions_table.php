...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sys_group_permissions', function (Blueprint $table) {
                        $table->bigIncrements('id_sys_group_permission');
            ...
            $table->foreign('id_sys_menu_permission')->references('id_sys_menu_permission')->on('sys_menu_permissions')->onDelete('set null');
        });
    }
